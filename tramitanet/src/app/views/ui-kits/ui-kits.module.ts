...
@NgModule({
  ...
  declarations: [ButtonsComponent, CardsComponent, CardsEcommerceComponent, AccordionsComponent, ModalsComponent, AlertsComponent, CardMetricsComponent, BadgesComponent, CardWidgetsComponent, LoadersComponent]
})
