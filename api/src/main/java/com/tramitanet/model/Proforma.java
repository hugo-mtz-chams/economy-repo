...
public class Proforma {
	...
	/**
	 * @param faVetada the faVetada to set
	 */
	...
	/**
	 * @param fraccionMala the fraccionMala to set
	 */
	...
	/**
	 * @param idCapturista the idCapturista to set
	 */
	...
	/**
	 * @param nombreExportador the nombreExportador to set
	 */
	...
	/**
	 * @param numModelo the numModelo to set
	 */
	...
	/**
	 * @param paisExportador the paisExportador to set
	 */
	...
	/**
	 * @param precioEstimado the precioEstimado to set
	 */
	...
	/**
	 * @param predictamen the predictamen to set
	 */
	...
	/**
	 * @return the validPrecioTotal
	 */
	public String getValidPrecioTotal() {
		return validPrecioTotal;
	}

	/**
	 * @param validPrecioTotal the validPrecioTotal to set
	 */
	...
	/**
	 * @param valorAntDesc the valorAntDesc to set
	 */
